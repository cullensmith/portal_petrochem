...
class Fertilizer_Plant(models.Model):
    id = models.IntegerField(primary_key=True, db_column='id')
    company = models.CharField(max_length=250, blank=True, null=True, db_column='company' )
    fertilizer = models.CharField(max_length=250, blank=True, null=True, db_column='fertilizer' )
    town = models.CharField(max_length=250, blank=True, null=True, db_column='town' )
    state = models.CharField(max_length=250, blank=True, null=True, db_column='state' )
    latitude = models.FloatField(blank=True, null=True, db_column='latitude')
    longitude = models.FloatField(blank=True, null=True, db_column='longitude')
    status = models.CharField(max_length=250, blank=True, null=True, db_column='status' )
    nitrogen_f = models.FloatField(blank=True, null=True, db_column='nitrogen_f')
    anyhdrousa = models.FloatField(blank=True, null=True, db_column='anyhdrousa')
    grossammon = models.FloatField(blank=True, null=True, db_column='grossammon')
    ammonia_bo = models.FloatField(blank=True, null=True, db_column='ammonia_bo')
    ammoniasto = models.CharField(max_length=250, blank=True, null=True, db_column='ammoniasto' )
    netammonia = models.CharField(max_length=250, blank=True, null=True, db_column='netammonia' )
    uan_thousa = models.CharField(max_length=250, blank=True, null=True, db_column='uan_thousa' )
    uanstorage = models.CharField(max_length=250, blank=True, null=True, db_column='uanstorage' )
    urea_thous = models.FloatField(blank=True, null=True, db_column='urea_thous')
    ureastorag = models.CharField(max_length=250, blank=True, null=True, db_column='ureastorag' )
    other_thou = models.CharField(max_length=250, blank=True, null=True, db_column='other_thou' )
    mmbtu_cons = models.CharField(max_length=250, blank=True, null=True, db_column='mmbtu_cons' )
    mcf_consum = models.CharField(max_length=250, blank=True, null=True, db_column='mcf_consum' )
    phosphoric = models.CharField(max_length=250, blank=True, null=True, db_column='phosphoric' )
    phosphor_1 = models.FloatField(blank=True, null=True, db_column='phosphor_1')
    processed = models.CharField(max_length=250, blank=True, null=True, db_column='processed_' )
    ammonium_u = models.CharField(max_length=250, blank=True, null=True, db_column='ammonium_u' )
    processed1 = models.CharField(max_length=250, blank=True, null=True, db_column='processed1' )
    ammonium_1 = models.CharField(max_length=250, blank=True, null=True, db_column='ammonium_1' )
    capacity_m = models.CharField(max_length=250, blank=True, null=True, db_column='capacity_m' )
    production = models.CharField(max_length=250, blank=True, null=True, db_column='production' )
    reserve_mi = models.CharField(max_length=250, blank=True, null=True, db_column='reserve_mi' )
    mmbtu_mill = models.CharField(max_length=250, blank=True, null=True, db_column='mmbtu_mill' )
    mcf_millio = models.CharField(max_length=250, blank=True, null=True, db_column='mcf_millio' )
    provenpeak = models.CharField(max_length=250, blank=True, null=True, db_column='provenpeak' )
    operationa = models.CharField(max_length=250, blank=True, null=True, db_column='operationa' )
    oremined_m = models.CharField(max_length=250, blank=True, null=True, db_column='oremined_m' )
    finishedpr = models.CharField(max_length=250, blank=True, null=True, db_column='finishedpr' )
    reserves_m = models.CharField(max_length=250, blank=True, null=True, db_column='reserves_m' )
    potashmine = models.CharField(max_length=250, blank=True, null=True, db_column='potashmine' )
    mmbtu_mi_1 = models.CharField(max_length=250, blank=True, null=True, db_column='mmbtu_mi_1' )
    mcf_mill_1 = models.CharField(max_length=250, blank=True, null=True, db_column='mcf_mill_1' )
    latitude1 = models.FloatField(blank=True, null=True, db_column='latitude1')
    longitude1 = models.FloatField(blank=True, null=True, db_column='longitude1')
    nitric_aci = models.FloatField(blank=True, null=True, db_column='nitric_aci')
    liquid_nit = models.FloatField(blank=True, null=True, db_column='liquid_nit')
    f41 = models.FloatField(blank=True, null=True, db_column='f41')
    ammonia_pe = models.CharField(max_length=250, blank=True, null=True, db_column='ammonia_pe' )
    nitrogenpr = models.CharField(max_length=250, blank=True, null=True, db_column='nitrogenpr' )
    links = models.CharField(max_length=250, blank=True, null=True, db_column='links' )
